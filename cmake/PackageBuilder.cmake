...
macro( pbuilder_add_submodule SM_NAME SM_LOCATION )
    ...
    if( NOT DEFINED PARENT_INC_DIR_PATH )
        ...
        set( PARENT_INC_DIR_PATH "${PARENT_INC_DIR_PATH}/${SM_NAME}" )
...
macro( pbuilder_install_headers )
    message( STATUS "installing headers in ${INCLUDE_INSTALL_DIR}${PARENT_INC_DIR_PATH}" )
    install( FILES ${ARGN} DESTINATION ${INCLUDE_INSTALL_DIR}${PARENT_INC_DIR_PATH} )
endmacro()
