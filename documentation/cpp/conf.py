...
latex_documents = [
  (master_doc, 'Scarab.tex', u'Scarab Documentation',
...
man_pages = [
    (master_doc, 'scarab', u'Scarab Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Scarab', u'Scarab Documentation',
   author, 'Scarab', 'Utility library for Project 8 C++ Software',
   'Miscellaneous'),
]
