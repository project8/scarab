...
#ifndef SCARAB_PARAM_MSGPACK_HH_
#define SCARAB_PARAM_MSGPACK_HH_
...
namespace scarab
{
    ...
    class SCARAB_API param_input_msgpack
    {
        public:
            param_input_msgpack();
    ...
    class SCARAB_API param_output_msgpack
    {
        public:
