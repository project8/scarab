...
namespace scarab_pybind
{
    std::list< std::string > export_signal_handler( pybind11::module& mod )
    {
        ...
        pybind11::class_< scarab::signal_handler >( mod, "SignalHandler", "handle system signals and pass cancel status to associated objects" )
            ...
            .def_static( "remove_cancelable", static_cast<void (scarab::signal_handler::*)(std::shared_ptr<scarab::cancelable>)>( &scarab::signal_handler::remove_cancelable ), "remove a cancelable object from the list to be canceled in the event of a SIGINT" )
